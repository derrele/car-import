...
export interface MarketOpportunity { listing:MarketListing; expectedSalePrice:number; marketDiscount:number; totalCost:number; adjustedProfit:number; roi:number; score:number; daysListed:number; priceDrop:number; negotiationSignal:"high"|"medium"|"none"; dgtTransfers2025?:number; }
